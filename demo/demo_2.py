...
the 2 mixture models using "pycluster" library.
"""

# Generate demo data
train_data_0, train_data_1, test_data = pycluster.gen_demo_dataset_2()

# Estimate optimal order and clustering data for class 0
[mtrs, class_0] = pycluster.gaussian_mixture(train_data_0, 20, 0, True, 'full', 1e5)
...
[mtrs, class_1] = pycluster.gaussian_mixture(train_data_1, 20, 0, True, 'full', 1e5)
...
likelihood[:, 0] = pycluster.GM_class_likelihood(class_0, test_data)[:, 0]
likelihood[:, 1] = pycluster.GM_class_likelihood(class_1, test_data)[:, 0]
