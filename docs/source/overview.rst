...
The package also includes two additional functions which make "gaussian_mixture" more useful. The function "compute_GM_class_likelihood" can be used to perform maximum likelihood classification from the parameter estimation generated by "estimate_gaussian_mixture", and the function "split_classes" can be used along with "estimate_gaussian_mixture" and "compute_GM_class_likelihood" to perform unsupervised classification.
